...
function checkSucess(category_id, content, date, description, image_credits, image_name, pref_size, short_title, title, uuid, visible, button_id, image_exists, lastImageName, author, image_is_simulation, image_simulation) {
    ...
    postNewDatas(category_id, content, date, description, image_credits, image_name, pref_size, short_title, title, uuid, visible, lastTitle, shouldRedirect, button_id, image_exists, lastImageName, author, image_is_simulation, image_simulation);
}


function postNewDatas(category_id, content, date, description, image_credits, image_name, pref_size, short_title, title, uuid, visible, lastTitle, shouldRedirect, button_id, image_exists, lastImageName, author, image_is_simulation, image_simulation) {
    let xhttp = new XMLHttpRequest();
    ...
    xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
    xhttp.send(`category_id=${category_id}&content=${content}&date=${date}&description=${description}&image_credits=${image_credits}&image_name=${image_name}&pref_size=${pref_size}&short_title=${short_title}&title=${title}&uuid=${uuid}&visible=${visible}&image_exists=${image_exists}&lastImageName=${lastImageName}&author=${author}&image_is_simulation=${image_is_simulation}&image_simulation=${image_simulation}`);
}
